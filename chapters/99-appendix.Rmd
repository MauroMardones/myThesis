...
## "Assessing environmental and predator impacts on Antarctic Krill (*Euphausia superba*) population dynamics from an integratedlength-to-age assessment model perspective"

This manuscript evaluates the influence of environmental factors and predator dynamics on Antarctic krill (*Euphausia superba*) population processes using an integrated length-to-age assessment modeling framework. The study incorporates ecosystem drivers into stock assessment analyses to explore their effects on krill growth, recruitment, and biomass trends. Results highlight how environmental variability and predation pressure jointly shape krill population dynamics, providing insights for ecosystem-based fisheries management in the Western Antarctic Peninsula.
...
# Supplementary Material in Stock Assessment Integrated Modelling {#appendix3}

## Code to reproduce stock assessment analisys

**Description**: Code, analysis, formulas, and outputs of stock assessment of Antarctic krill in WAP can be found in this [link](https://mauromardones.github.io/SA_Krill/). 

```{r convert-and-include3, eval= FALSE, fig.align='center', out.width='100%'}
# Definir la ruta del PDF
pdf_path <- "~/DOCAS/WG/SAM_2025/WG_SAM_2025_11.pdf"
