...
```{r rmseplot, eval=FALSE, fig.cap="Root Mean Square Error (RMSE) distributions for four krill population model scenarios"}
knitr::include_graphics('figure/RMSE_Value.jpeg')
```
