...
```{r envf, out.width='100%', fig.pos= "H", fig.cap="Key environmental and population variables of Antarctic krill. Temporal variation in biomass estimates, fisheries catch data, and environmental drivers across management units in the Antarctic Peninsula region"}
