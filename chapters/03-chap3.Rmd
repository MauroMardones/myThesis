# Spatial hetergoneity in krill population dynamics in WAP {#chap3}
...
> By analyzing spatial patterns alongside environmental drivers and biological indicators that vary across regions, this thesis aims to enhance the resolution and realism of stock assessments and to support spatially explicit management measures. Recognizing and incorporating the spatial scale at which krill aggregate allows for a more accurate representation of population dynamics and aligns management strategies with spatial heterogeneity in the WAP.
...
> Despite its importance, the Commission for the Conservation of Antarctic Marine Living Resources (CCAMLR) has yet to fully implement spatially structured models or management approaches that reflect the complex spatial ecology of krill populations in the WAP.
...
```{r plothcr, out.width="80%", fig.cap="Harvest Control Rule Based on SPR proposed to krill in WAP"}
...
This result can found in manuscript in  [Appendix 1](#appendix1)
