...
By analyzing spatial patterns alongside environmental drivers and biological indicators that vary across MU in Subarea 48.1, this chapter aims to enhance the resolution and realism of population dynamics and to support spatially explicit management measures. Recognizing and incorporating the spatial scale at which krill aggregate allows for a more accurate representation of population dynamics and aligns management strategies with spatial heterogeneity in the WAP.
...
```{r GraphAbstr, echo=FALSE, out.width='50%',fig.cap="Schematic illustrating the spatial distribution of Antarctic krill under the current Harvest Control Rule (HCR) compared to the proposed HCR, which incorporates spatial heterogeneity in krill intrinsic productivity (Spawning Potential Ratio, SPR)."}
