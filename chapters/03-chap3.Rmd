...
```{r grabst, out.width='80%',fig.cap="Schematic showing Antarctic krill spatial distribution under the current Harvest Control Rule (HCR) versus a proposed HCR that accounts for spatial variation in intrinsic productivity (Spawning Potential Ratio, SPR)."}
