...
\degrees{Marine Biologist, Universidad de Concepción}
\def\country{Chile}
\def\department{CIGA}
\def\university{Universidad de Magallanes}
\def\degreetitle{Doctor in Antarctic and SubAntarctic Science}
...
\hypersetup{
     ...
     pdftitle={Dynamics populations and Fishery of Krill (\emph{Euphausia superba}) along the Western Antarctic Peninsula},
